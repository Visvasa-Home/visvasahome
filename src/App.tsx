...
const seoMeta: Record<string, { title: string; description: string }> = {
  ...
  'professional-register': {
    ...
    description: 'Join VisvasaHome as a verified professional partner. Register FREE as electrician, plumber, AC technician, carpenter, cleaner, painter, or home repair specialist. Earn ₹30,000–₹90,000/month with AMC income, fair pricing, free training, and verified badge. India\'s most trusted local services professional network.',
  },
  'benefits': {
  ...
  'about-us': {
    ...
    description: 'Learn about VisvasaHome — India\'s trusted local services ecosystem. Our story, values, team, and commitment to trust-driven services.',
  },
  'our-mission': {
  ...
  'plumbing-services': {
    ...
    description: 'Book expert plumbers for tap repair, leak fixing, pipe fitting, geyser installation, drainage work & more. 30-min arrival, verified professionals, service warranty. Starting ₹299. Emergency plumbing available 24/7.',
  },
  'electrical-services': {
    title: 'Licensed Electricians | Electrical Services | VisvasaHome',
    description: 'Book certified electricians for wiring, switch repair, fan installation, inverter setup & more. Licensed professionals, same-day service, 90-day warranty. Starting ₹199. 24/7 emergency electrical service available.',
  },
  'ac-services': {
    title: 'AC Service & Repair | AC Installation | VisvasaHome',
    description: 'Professional AC service, repair, installation & gas charging. Certified technicians for all AC brands. 90-day warranty on gas filling. Starting ₹349. Same-day service available.',
  },
  'cleaning-services': {
    title: 'Home Cleaning Services | Deep Cleaning | VisvasaHome',
    description: 'Book professional cleaning services - home cleaning, deep cleaning, kitchen, bathroom, sofa, carpet & more. Eco-friendly products, background-verified cleaners. Starting ₹799. 7-day satisfaction guarantee.',
  },
  'appliance-repair': {
    title: 'Appliance Repair Services | Refrigerator, Washing Machine Repair | VisvasaHome',
    description: 'Expert appliance repair for refrigerator, washing machine, microwave, TV, dishwasher & more. 30-day warranty on all repairs. Starting ₹399. Same-day service available across India.',
  },
  'pest-control': {
    title: 'Pest Control Services | Cockroach, Termite, Bedbug Control | VisvasaHome',
    description: 'Safe, eco-friendly pest control for cockroach, termite, bedbug, rodent & more. Licensed technicians, up to 90-day warranty. Starting ₹799. Get pest-free home today.',
  },
  'painting-services': {
    title: 'Professional Painting Services | Interior & Exterior Painting | VisvasaHome',
    description: 'Expert painting contractors for interior, exterior & texture painting. Premium brands, skilled painters, 1-year warranty. Starting ₹3,999. Free color consultation included.',
  },
  'carpentry-services': {
    title: 'Carpentry Services | Furniture Assembly | Wardrobe Installation | VisvasaHome',
    description: 'Skilled carpenters for furniture assembly, wardrobe, kitchen cabinets, door frames & custom woodwork. Quality craftsmanship guaranteed. Starting ₹499.',
  },
  'interior-design': {
    title: 'Interior Design Services | Modular Kitchen | Home Interiors | VisvasaHome',
    description: 'Transform your home with expert interior designers. Modular kitchen, wardrobes, full home interiors, 3D design. Premium materials, professional execution. Starting ₹4,999.',
  },
  'landscaping-services': {
    title: 'Landscaping Services | Garden Design | Lawn Maintenance | VisvasaHome',
    description: 'Expert landscaping services - garden design, lawn maintenance, tree planting & outdoor specialists. Transform your outdoor space. Starting ₹799.',
  },
  'flooring-services': {
    title: 'Flooring Services | Tile, Marble, Wooden Flooring | VisvasaHome',
    description: 'Professional flooring contractors for tile, marble, wooden flooring installation & polishing. Premium finish guaranteed. Starting ₹29/sqft.',
  },
  'masonry-services': {
  ...
  'roofing-services': {
    ...
    description: 'Professional roofing contractors for roof installation, repair, waterproofing. Weather protection guaranteed. Starting ₹2,999.',
  },
  'general-repair': {
    title: 'General Repair & Maintenance | Handyman Services | VisvasaHome',
    description: 'Quick handyman services for door repair, lock installation, wall mounting & general home repairs. Fast, reliable service. Starting ₹299.',
  },
  'excavation-services': {
  ...
  'care-services': {
    ...
    description: 'Professional care services - baby care, nanny, elderly care assistance, patient care. Background-verified caregivers. Starting ₹999/day.',
  },
  'event-services': {
    title: 'Event Services | Wedding Decoration | Birthday Party Setup | VisvasaHome',
    description: 'Professional event services - wedding decoration, birthday party setup, festival decoration. Make your events memorable. Starting ₹2,999.',
  },
  'construction-services': {
  ...
  'partner-home': {
    title: 'Partner with VisvasaHome | Earn ₹30,000-₹90,000/Month as Service Professional',
  ...
  'partner-about': {
    ...
    description: 'Learn about VisvasaHome\'s mission to empower service professionals. 50,000+ partners, ₹225Cr+ earnings distributed. Join our community today.',
  },
  'partner-terms': {
  ...
  'partner-city-jaipur': {
    ...
    description: 'Join 3,200+ service professionals earning ₹42,000/month average in Jaipur. 2,500+ monthly jobs available. Register free.',
  },
  'partner-city-delhi': {
    title: 'Partner with VisvasaHome in Delhi NCR | 12,000+ Active Partners',
    description: 'Join 12,000+ service professionals earning ₹52,000/month average in Delhi NCR. 8,500+ monthly jobs. Premium market opportunities.',
  },
  'partner-city-mumbai': {
    title: 'Partner with VisvasaHome in Mumbai | 15,000+ Active Partners',
    description: 'Join 15,000+ service professionals earning ₹58,000/month average in Mumbai. Highest earning potential in India. Register now.',
  },
  'partner-city-bangalore': {
    title: 'Partner with VisvasaHome in Bangalore | 10,500+ Active Partners',
    description: 'Join 10,500+ service professionals earning ₹51,000/month average in Bangalore. Tech-savvy customers, consistent demand.',
  },
  'partner-city-pune': {
    title: 'Partner with VisvasaHome in Pune | 5,500+ Active Partners',
    description: 'Join 5,500+ service professionals earning ₹46,000/month average in Pune. Growing IT hub with 4,500+ monthly jobs.',
  },
  'partner-city-hyderabad': {
    title: 'Partner with VisvasaHome in Hyderabad | 7,000+ Active Partners',
    description: 'Join 7,000+ service professionals earning ₹48,000/month average in Hyderabad. 5,500+ monthly jobs in growing tech city.',
  },
  'partner-city-chennai': {
  ...
  'refund-policy': {
    ...
    description: 'VisvasaHome cancellation, refund, shipping and payment gateway policy. Free cancellation up to 2 hours before service. Refund to original payment method within 5–7 business days.',
  },
  'services-pricing': {
    title: 'Services & Pricing | VisvasaHome — All Plans in INR',
