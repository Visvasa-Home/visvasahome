    ...
    <div className="flex flex-col" style={{ fontFamily: 'inherit' }}>
      ...
      <div className="flex items-center gap-2 px-4 py-2 bg-blue-50 border-b border-blue-100 flex-shrink-0">
        ...
        <p className="text-[10px] font-bold text-blue-700">
          Drag/pan the map under the <span className="text-red-500">📍 center pin</span> to set your exact location
        </p>
      </div>
      ...
      <div className="relative w-full h-[280px] bg-gray-100 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-[999]">
          <div className="relative flex flex-col items-center select-none" style={{ transform: 'translateY(-16px)' }}>
            ...
            {!isMoving && !isLoading && (
              <div className="absolute w-8 h-8 -top-1 bg-red-400/20 border border-red-500/30 rounded-full animate-ping pointer-events-none"></div>
            )}
            
            {/* The pin itself */}
            <div className={`w-8 h-8 rounded-full bg-red-500 border-2 border-white shadow-lg flex items-center justify-center transition-all duration-200 ${isMoving ? 'scale-110 -translate-y-2.5 shadow-xl' : ''}`}>
              <div className="w-2.5 h-2.5 bg-white rounded-full"></div>
            </div>
            {/* Pin Stem */}
            <div className="w-1 h-3.5 bg-red-500 shadow-md"></div>
