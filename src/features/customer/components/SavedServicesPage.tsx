...
const initialSaved: SavedService[] = [
  { id: '1', name: 'Deep Home Cleaning', category: 'Cleaning', icon: Heart, iconBg: 'bg-teal-100 text-teal-600', startingFrom: 1299, rating: 4.8, reviews: 2341, saved: true },
  { id: '2', name: 'AC Service & Repair', category: 'Appliance Repair', icon: Wind, iconBg: 'bg-cyan-100 text-cyan-600', startingFrom: 599, rating: 4.7, reviews: 1876, saved: true },
  { id: '3', name: 'Full Home Painting', category: 'Painting', icon: Paintbrush2, iconBg: 'bg-purple-100 text-purple-600', startingFrom: 8000, rating: 4.9, reviews: 987, saved: true },
  { id: '4', name: 'Electrical Wiring & Fitting', category: 'Electrical', icon: Zap, iconBg: 'bg-yellow-100 text-yellow-600', startingFrom: 299, rating: 4.6, reviews: 3210, saved: true },
  ...
  { id: '6', name: 'Salon at Home', category: 'Beauty', icon: Scissors, iconBg: 'bg-pink-100 text-pink-600', startingFrom: 399, rating: 4.9, reviews: 5432, saved: true },
];
                ...
                <div key={svc.id} className="bg-white rounded-2xl shadow-sm p-4 flex items-center gap-4 border border-gray-100">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      ...
                      <span className="text-xs text-yellow-600 font-semibold">★ {svc.rating}</span>
                  ...
                  <div className="flex flex-col gap-2 shrink-0">
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 bg-red-50 text-red-500 text-xs font-semibold rounded-lg hover:bg-red-100 transition-colors flex items-center justify-center gap-1"
                    >
