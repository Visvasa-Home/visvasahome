    ...
    <div className="min-h-screen bg-gradient-to-br from-[#2563EB] via-[#1D4ED8] to-[#1D4ED8] flex items-center justify-center p-4">
      <Card className="w-full max-w-md p-6 lg:p-8 shadow-2xl relative overflow-hidden bg-white">
        ...
        <form onSubmit={handleLogin} className="space-y-4 relative z-10">
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-xl p-3 lg:p-4 flex items-start gap-3 animate-shake">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`pl-10 h-12 text-base rounded-xl ${emailDomainError ? 'border-red-400 focus:border-red-500 focus:ring-red-200' : ''}`}
                required
              />
            </div>
            {emailDomainError ? (
            ...
            {ssoLoadingStep ? (
              ...
              <>
                <div className="text-center mb-6">
                  ...
                  <p className="text-xs text-gray-500 mt-1">Only <span className="font-bold text-indigo-600">@visvasahome.com</span> accounts can access the admin panel</p>
                </div>
                ...
                <div className="space-y-2.5">
                  {mockSSOAccounts.map((acc) => (
                    ...
                    >
                      <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-bold text-sm shadow-xs group-hover:scale-105 transition-transform">
                        {acc.avatar}
                      </div>
