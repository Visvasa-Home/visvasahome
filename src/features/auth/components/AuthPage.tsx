          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm ${
                step === 'phone' ? 'bg-[#2563EB] text-white' : 'bg-green-500 text-white'
              }`}>
            ...
            <div className="flex items-center gap-2">
              <div className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold text-sm ${
                ...
                step === 'otp' ? 'bg-green-500 text-white' :
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full p-5 border-2 border-gray-200 rounded-xl hover:border-green-600 hover:bg-green-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-4 group"
                  >
              ...
              <div>
                <div className="text-center mb-8">
                  <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center ${
                    ...
                    selectedMethod === 'whatsapp' ? 'bg-green-100' :
                    'bg-blue-100'
                  }`}>
                    {(() => {
                      ...
                      return <Icon className={`w-8 h-8 ${
                        ...
                        selectedMethod === 'whatsapp' ? 'text-green-600' :
                        'text-blue-600'
                      }`} />;
                    })()}
                  </div>
