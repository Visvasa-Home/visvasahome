...
export function PetCarePage({ onBack, onBookNow }: PetCarePageProps) {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <div className="bg-gradient-to-br from-yellow-500 via-amber-500 to-yellow-600 text-white relative overflow-hidden">
          ...
          <div className="py-10 max-w-4xl">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-yellow-100 text-lg">Professional dog grooming, walking, vet visits, and cage-free home boarding</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <Button onClick={onBookNow} size="lg" className="bg-white text-yellow-750 hover:bg-yellow-50 font-bold px-8 py-3 text-base">
                Book Pet Service
              </Button>
      ...
      {/* Highlights */}
      <div className="bg-yellow-50/50 border-b border-yellow-100/40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {highlights.map((h, i) => (
              <div key={i} className="flex flex-col items-center text-center">
                <div className="w-12 h-12 bg-yellow-600 rounded-xl flex items-center justify-center mb-3">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-16">
          {services.map((s, i) => (
            <Card key={i} className="p-5 hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-yellow-200 rounded-2xl">
              <div className="flex justify-between items-start mb-3">
                <h3 className="font-bold text-base text-gray-900 leading-tight">{s.name}</h3>
                {s.popular && <Badge className="bg-yellow-600 text-white text-xs flex-shrink-0 ml-2">Popular</Badge>}
              </div>
              ...
              <div className="flex justify-between items-center mb-3 pt-3 border-t border-gray-100">
                <div>
                  ...
                  <p className="font-bold text-yellow-600 text-lg">{s.price}</p>
                </div>
        ...
        {/* Steps */}
        <div className="bg-yellow-50/50 rounded-3xl p-10 mb-16">
        ...
        {/* CTA */}
        <section className="text-center bg-gradient-to-r from-yellow-500 to-amber-600 rounded-3xl p-14 text-white">
          ...
          <Button onClick={onBookNow} size="lg" className="bg-white text-yellow-750 hover:bg-yellow-50 font-bold px-12">
