...
export function CareersPage({ onBack }: CareersPageProps) {
  ...
  const perks = [
    { icon: Heart, title: 'Health Insurance', description: 'Comprehensive medical coverage for you and your family', color: 'bg-red-50 text-red-600' },
    ...
    { icon: Award, title: 'Performance Bonus', description: 'Quarterly bonuses based on performance and company growth', color: 'bg-yellow-50 text-yellow-600' },
    { icon: Plane, title: 'Team Retreats', description: 'Annual all-expense-paid team trips and quarterly outings', color: 'bg-green-50 text-green-600' },
    { icon: Laptop, title: 'Latest Tech', description: 'MacBook Pro, ergonomic setup, and premium tools', color: 'bg-purple-50 text-purple-600' },
    { icon: Home, title: 'WFH Setup', description: '₹20,000 budget for home office setup', color: 'bg-indigo-50 text-indigo-600' },
    { icon: DollarSign, title: 'Competitive Salary', description: 'Market-leading compensation with ESOPs for early employees', color: 'bg-teal-50 text-teal-600' },
    { icon: Users, title: 'Inclusive Culture', description: 'Diverse, welcoming environment where everyone belongs', color: 'bg-pink-50 text-pink-600' },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="flex flex-wrap gap-12 mb-8">
                ...
                <div>
                  <div className="text-5xl font-bold text-pink-600 mb-1">10K+</div>
            ...
            <div className="grid grid-cols-3 gap-4 relative">
              ...
              <div className="col-span-1 space-y-4 mt-8">
                <div className="bg-gradient-to-br from-green-400 to-green-600 rounded-3xl h-40 shadow-lg"></div>
                <div className="bg-gradient-to-br from-red-400 to-red-600 rounded-3xl h-32 shadow-lg"></div>
              </div>
              <div className="col-span-1 space-y-4">
                <div className="bg-gradient-to-br from-purple-400 to-purple-600 rounded-3xl h-36 shadow-lg"></div>
                <div className="bg-gradient-to-br from-yellow-400 to-yellow-600 rounded-3xl h-36 shadow-lg"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { name: 'Amit Sharma', role: 'Chief Technology Officer', initial: 'AS', gradient: 'from-purple-400 to-purple-600' },
              { name: 'Priya Verma', role: 'Head of Operations', initial: 'PV', gradient: 'from-pink-400 to-pink-600' },
              { name: 'Rajesh Kumar', role: 'Head of Product', initial: 'RK', gradient: 'from-teal-400 to-teal-600' },
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-br from-[#2563EB] via-purple-600 to-pink-600 relative overflow-hidden">
