...
export function EducationPage({ onBack, onBookNow }: EducationPageProps) {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <div className="bg-gradient-to-br from-blue-600 via-amber-500 to-blue-700 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {/* CTA */}
        <section className="text-center bg-gradient-to-r from-blue-600 to-amber-600 rounded-3xl p-14 text-white">
