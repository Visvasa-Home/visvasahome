                    ...
                    return (
                      ...
                      >
                        <div className="bg-[#f5f5f5] w-16 h-16 rounded-xl flex flex-col items-center justify-center mb-2 relative group-hover:scale-105 transition-transform">
                          ...
                          {sub.timeEstimate && (
                            <div className="absolute -bottom-2 bg-white px-2 py-0.5 rounded-full border border-gray-200 text-[9px] font-bold text-emerald-600 shadow-sm whitespace-nowrap">
                              {sub.timeEstimate}
                            </div>
                          )}
                          {sub.isNew && (
                            <div className="absolute -top-2 right-[-10px] bg-amber-500 text-white px-1.5 py-0.5 rounded text-[8px] font-black uppercase shadow-sm">
                              NEW
                            </div>
                          )}
                        </div>
