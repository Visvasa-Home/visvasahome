...
const acApplianceServices = [
  { name: 'AC Service\n& Repair', icon: Wind, slug: 'ac-services', color: 'bg-sky-100 text-sky-700', desc: '₹349 onwards' },
  { name: 'Water Purifier\nServices & Repair', icon: Droplets, slug: 'plumbing-services', color: 'bg-cyan-100 text-cyan-700', desc: '₹499 onwards' },
  { name: 'Air Cooler\nServices & Repair', icon: Airplay, slug: 'appliance-repair', color: 'bg-blue-100 text-blue-700', desc: '₹299 onwards' },
  { name: 'Refrigerator\nRepair & Consult', icon: Refrigerator, slug: 'appliance-repair', color: 'bg-indigo-100 text-indigo-700', desc: '₹399 onwards' },
  { name: 'Washing Machine\nRepair', icon: WashingMachine, slug: 'appliance-repair', color: 'bg-violet-100 text-violet-700', desc: '₹299 onwards' },
  { name: 'TV & Display\nRepair', icon: Tv, slug: 'appliance-repair', color: 'bg-purple-100 text-purple-700', desc: '₹499 onwards' },
  { name: 'Geyser / Water\nHeater Repair', icon: Flame, slug: 'appliance-repair', color: 'bg-orange-100 text-orange-700', desc: '₹249 onwards' },
  { name: 'Microwave\nRepair', icon: Coffee, slug: 'appliance-repair', color: 'bg-amber-100 text-amber-700', desc: '₹299 onwards' },
];

// ── Section 2: Cleaning & Pest Control ──
const cleaningServices = [
  { name: 'Full Home\nDeep Cleaning', icon: Sparkles, slug: 'cleaning-services', color: 'bg-emerald-100 text-emerald-700', desc: '₹1,899 onwards' },
  { name: 'Carpet & Sofa\nCleaning', icon: Sofa, slug: 'cleaning-services', color: 'bg-teal-100 text-teal-700', desc: '₹199 / seat' },
  { name: 'Ants & Bed Bugs\nControl', icon: Bug, slug: 'pest-control', color: 'bg-red-100 text-red-700', desc: '₹699 onwards' },
  { name: 'Bathroom &\nKitchen Cleaning', icon: ShowerHead, slug: 'cleaning-services', color: 'bg-blue-100 text-blue-700', desc: '₹599 onwards' },
  { name: 'Bathroom\nCleaning', icon: ShowerHead, slug: 'cleaning-services', color: 'bg-cyan-100 text-cyan-700', desc: '₹349 onwards' },
  { name: 'By Room\nCleaning', icon: Home, slug: 'cleaning-services', color: 'bg-green-100 text-green-700', desc: '₹499 onwards' },
  { name: 'Cockroach\nControl', icon: Bug, slug: 'pest-control', color: 'bg-rose-100 text-rose-700', desc: '₹699 onwards' },
  { name: 'Termite\nControl', icon: Bug, slug: 'pest-control', color: 'bg-amber-100 text-amber-700', desc: '₹1,499 onwards' },
];
...
const salonMassageServices = [
  ...
  { name: 'Full Body\nMassage', icon: Dumbbell, slug: 'wellness-services', color: 'bg-violet-100 text-violet-700', desc: '₹699 onwards' },
  { name: "Women's\nSalon at Home", icon: Scissors, slug: 'beauty-services', color: 'bg-pink-100 text-pink-700', desc: '₹249 onwards' },
  { name: 'Facial\n& Cleanup', icon: Baby, slug: 'beauty-services', color: 'bg-fuchsia-100 text-fuchsia-700', desc: '₹399 onwards' },
  { name: 'Yoga &\nFitness', icon: Dumbbell, slug: 'wellness-services', color: 'bg-lime-100 text-lime-700', desc: '₹499 / session' },
];

// ── Section 4: Electricians, Plumbers, Carpenters, Builders, Gardner, Painter ──
const tradesServices = [
  { name: 'Electrician\n& Wiring', icon: Zap, slug: 'electrical-services', color: 'bg-yellow-100 text-yellow-700', desc: '₹99 onwards' },
  { name: 'Plumbing\nRepairs', icon: Droplets, slug: 'plumbing-services', color: 'bg-blue-100 text-blue-700', desc: '₹149 onwards' },
  { name: 'Carpenter /\nFurniture Repair', icon: Hammer, slug: 'carpentry-services', color: 'bg-amber-100 text-amber-700', desc: '₹149 onwards' },
  { name: 'Furniture\nAssembly', icon: Package, slug: 'carpentry-services', color: 'bg-orange-100 text-orange-700', desc: '₹249 onwards' },
  { name: 'General\nRepair', icon: Wrench, slug: 'general-repair', color: 'bg-slate-100 text-slate-700', desc: '₹199 onwards' },
  { name: 'CCTV &\nSecurity', icon: ShieldCheck, slug: 'electrical-services', color: 'bg-indigo-100 text-indigo-700', desc: '₹599 onwards' },
  { name: 'Gardening &\nLandscaping', icon: Leaf, slug: 'landscaping-services', color: 'bg-green-100 text-green-700', desc: '₹499 onwards' },
  { name: 'Painter\n(Professional)', icon: PaintBucket, slug: 'painting-services', color: 'bg-purple-100 text-purple-700', desc: '₹8,000 onwards' },
  { name: 'Builder /\nContractor', icon: HardHat, slug: 'construction-services', color: 'bg-stone-100 text-stone-700', desc: 'Get Quote' },
  { name: 'Water Purifier\nRO Service', icon: Droplets, slug: 'plumbing-services', color: 'bg-sky-100 text-sky-700', desc: '₹499 onwards' },
];

// ── Section 5: Painting, Waterproofing & Wallpanels ──
const paintingServices = [
  { name: 'Rooms / Walls\nPainting', icon: PaintBucket, slug: 'painting-services', color: 'bg-purple-100 text-purple-700', desc: '₹2,499 onwards' },
  { name: 'Wall Panels\nInstallation', icon: Layers, slug: 'general-repair', color: 'bg-emerald-100 text-emerald-700', desc: '₹1,999 onwards' },
  { name: 'Wall Makeover\nby Revamp', icon: Layers, slug: 'painting-services', color: 'bg-fuchsia-100 text-fuchsia-700', desc: '₹3,499 onwards' },
  { name: 'Full Home\nPainting', icon: PaintBucket, slug: 'painting-services', color: 'bg-violet-100 text-violet-700', desc: '₹8,000 onwards' },
  { name: 'Waterproofing\n& Seepage Fix', icon: Waves, slug: 'painting-services', color: 'bg-blue-100 text-blue-700', desc: '₹3,499 onwards' },
  { name: 'Texture &\nWall Design', icon: Layers, slug: 'painting-services', color: 'bg-indigo-100 text-indigo-700', desc: '₹2,499 onwards' },
  { name: 'Exterior\nPainting', icon: PaintBucket, slug: 'painting-services', color: 'bg-sky-100 text-sky-700', desc: '₹12,000 onwards' },
  { name: 'Wood Polish\n& Varnish', icon: Hammer, slug: 'carpentry-services', color: 'bg-amber-100 text-amber-700', desc: '₹799 onwards' },
];
...
const trendingCategories = [
  ...
  { name: 'Refrigerator Repair', icon: Refrigerator, slug: 'appliance-repair', bookings: '520 booked today', tag: '❄️ Cool', color: 'from-indigo-500 to-blue-600' },
  { name: 'Air Purifier Service', icon: Wind, slug: 'appliance-repair', bookings: '310 booked today', tag: '🌿 Air', color: 'from-teal-500 to-cyan-600' },
  { name: 'Store Service & Repair', icon: Store, slug: 'appliance-repair', bookings: '210 booked today', tag: '🏪 Store', color: 'from-amber-500 to-orange-600' },
  { name: 'Television Repair', icon: Tv, slug: 'appliance-repair', bookings: '740 booked today', tag: '📺 TV', color: 'from-purple-500 to-violet-600' },
  { name: 'Doctor Consultation', icon: Stethoscope, slug: 'wellness-services', bookings: '1,200 booked today', tag: '🩺 Health', color: 'from-rose-500 to-red-600' },
  { name: 'AC Service', icon: Wind, slug: 'ac-services', bookings: '1,240 booked today', tag: '🔥 Hot', color: 'from-sky-500 to-blue-600' },
  { name: 'Deep Cleaning', icon: Sparkles, slug: 'cleaning-services', bookings: '2,800 booked today', tag: '⭐ Best Seller', color: 'from-emerald-500 to-teal-600' },
  { name: 'Salon at Home', icon: Scissors, slug: 'beauty-services', bookings: '1,890 booked today', tag: '💅 Trending', color: 'from-pink-500 to-fuchsia-600' },
  { name: 'Electrician', icon: Zap, slug: 'electrical-services', bookings: '910 booked today', tag: '⚡ Express', color: 'from-yellow-500 to-amber-600' },
  { name: 'Painting', icon: PaintBucket, slug: 'painting-services', bookings: '480 booked today', tag: '🎨 Popular', color: 'from-purple-500 to-violet-600' },
  { name: 'Pest Control', icon: Bug, slug: 'pest-control', bookings: '320 booked today', tag: '✅ Safe', color: 'from-red-500 to-rose-600' },
];
...
const recentlyBooked = [
  { name: 'Electricians', icon: Zap, slug: 'electrical-services', sub: 'Switch, fan & wiring repairs', color: 'bg-yellow-100 text-yellow-700' },
...
const amcPlans = [
  ...
  { label: 'Weekly', icon: RotateCcw, slug: 'amc-packages', desc: 'Every week at your home', color: 'from-emerald-500 to-teal-600', badge: 'Save 15%' },
  { label: 'Monthly', icon: CalendarDays, slug: 'amc-packages', desc: 'Best for regular upkeep', color: 'from-purple-500 to-violet-600', badge: 'Save 25%' },
  { label: 'Yearly', icon: ShieldCheck, slug: 'amc-packages', desc: 'Full year peace of mind', color: 'from-amber-500 to-orange-600', badge: 'Best Value' },
];
    ...
    <section id="tour-services-grid" className="bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <ExploreSection
          ...
          emoji="❄️"
          accentColor="border-sky-200 text-sky-700 bg-sky-50"
        ...
        <ExploreSection
          ...
          emoji="💈"
          accentColor="border-pink-200 text-pink-700 bg-pink-50"
            ...
            <div className="bg-gradient-to-r from-stone-700 to-stone-900 p-4 sm:p-5 text-white flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5 sm:mb-1">
                  <span className="text-[8px] sm:text-[9px] font-black bg-amber-500 text-white px-1.5 sm:px-2 py-0.5 rounded-md uppercase tracking-wide">New</span>
