            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-4 mt-3 text-xs text-white/95 font-semibold">
                  <span className="flex items-center gap-1"><Star className="w-3.5 h-3.5 fill-amber-400 text-amber-400" /> 4.85 (82k bookings)</span>
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
          <div className="flex items-center gap-3 overflow-x-auto scrollbar-none">
            ...
            <span className="ml-auto shrink-0 bg-white text-emerald-700 text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-wide cursor-pointer hover:bg-emerald-50 transition-colors">
              SAVE20 — 20% off
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-2 mb-2">
              ...
              <span className="inline-flex items-center gap-1 bg-emerald-50 border border-emerald-100 text-emerald-700 text-[10px] font-bold px-2 py-0.5 rounded-full">
                🛡️ 90-day Warranty
              </span>
            </div>
                    ...
                    >
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1.5">
                          ...
                          {service.popular && (
                            <Badge className="bg-amber-500 text-white font-bold text-[9px] px-2 py-0.5 uppercase tracking-wide">
                              Bestseller
                            </Badge>
                          )}
                        </div>
