...
export function ServicesOffered({ onServiceClick }: ServicesOfferedProps) {
  ...
  const maintenanceServices: ServiceCard[] = [
    ...
    { name: "Appliances", icon: Refrigerator, slug: "appliance-repair", pillar: "maintenance", color: "bg-rose-50 text-rose-600 border-rose-100 hover:bg-rose-500 hover:text-white" },
    { name: "Pest Control", icon: HardHat, slug: "pest-control", pillar: "maintenance", color: "bg-red-50 text-red-650 border-red-100 hover:bg-red-500 hover:text-white" },
    { name: "Home Cleaning", icon: Sparkles, slug: "cleaning-services", pillar: "maintenance", color: "bg-emerald-50 text-emerald-600 border-emerald-100 hover:bg-emerald-500 hover:text-white" },
  ];
  ...
  const constructionServices: ServiceCard[] = [
    ...
    { name: "Electrical", icon: Zap, slug: "electrical-services", pillar: "construction", color: "bg-amber-50 text-amber-600 border-amber-100 hover:bg-amber-500 hover:text-white" },
    { name: "AC & HVAC", icon: Wind, slug: "ac-services", pillar: "construction", badge: "Seasonal", color: "bg-sky-50 text-sky-600 border-sky-100 hover:bg-sky-500 hover:text-white" },
    { name: "Wall Painting", icon: PaintBucket, slug: "painting-services", pillar: "construction", color: "bg-purple-50 text-purple-600 border-purple-100 hover:bg-purple-500 hover:text-white" },
    { name: "Carpentry & Wood", icon: Hammer, slug: "carpentry-services", pillar: "construction", color: "bg-teal-50 text-teal-600 border-teal-100 hover:bg-teal-500 hover:text-white" },
    ...
    { name: "Roofing", icon: Home, slug: "roofing-services", pillar: "construction", color: "bg-amber-50 text-amber-700 border-amber-100 hover:bg-amber-500 hover:text-white" },
  ];

  // ── 3. Design & Finishing ──
  const designServices: ServiceCard[] = [
    { name: "Interior Design", icon: Sofa, slug: "interior-design", pillar: "design", badge: "Premium", color: "bg-indigo-50 text-indigo-600 border-indigo-100 hover:bg-indigo-500 hover:text-white" },
    { name: "Landscaping", icon: TreePine, slug: "landscaping-services", pillar: "design", color: "bg-emerald-50 text-emerald-700 border-emerald-100 hover:bg-emerald-500 hover:text-white" },
    { name: "Flooring", icon: Frame, slug: "flooring-services", pillar: "design", color: "bg-cyan-50 text-cyan-600 border-cyan-100 hover:bg-cyan-500 hover:text-white" },
  ];

  // ── 4. Specialty & Personal Care ──
  const specialtyServices: ServiceCard[] = [
    { name: "At-Home Salon", icon: Scissors, slug: "beauty-services", pillar: "specialty", color: "bg-pink-50 text-pink-600 border-pink-100 hover:bg-pink-500 hover:text-white" },
    { name: "Wellness & Fitness", icon: Heart, slug: "wellness-services", pillar: "specialty", color: "bg-rose-50 text-rose-500 border-rose-100 hover:bg-rose-500 hover:text-white" },
    { name: "Care & Support", icon: Baby, slug: "care-services", pillar: "specialty", color: "bg-violet-50 text-violet-600 border-violet-100 hover:bg-violet-500 hover:text-white" },
    { name: "Event Setup", icon: PartyPopper, slug: "event-services", pillar: "specialty", color: "bg-amber-50 text-amber-700 border-amber-100 hover:bg-amber-500 hover:text-white" },
  ];

  // ── 5. AMC Plans ──
  const amcServices: ServiceCard[] = [
    { name: "Home AMC", icon: Home, slug: "amc-home", pillar: "amc", badge: "Most Popular", color: "bg-indigo-50 text-indigo-600 border-indigo-100 hover:bg-indigo-500 hover:text-white" },
    ...
    { name: "Commercial AMC", icon: Building, slug: "amc-commercial", pillar: "amc", color: "bg-purple-50 text-purple-650 border-purple-100 hover:bg-purple-500 hover:text-white" },
    ...
    { name: "Healthcare AMC", icon: Hospital, slug: "amc-healthcare", pillar: "amc", color: "bg-green-50 text-green-600 border-green-100 hover:bg-green-500 hover:text-white" },
    { name: "Educational AMC", icon: GraduationCap, slug: "amc-educational", pillar: "amc", color: "bg-amber-50 text-amber-600 border-amber-100 hover:bg-amber-500 hover:text-white" },
    { name: "Hospitality AMC", icon: Hotel, slug: "amc-hospitality", pillar: "amc", color: "bg-rose-50 text-rose-600 border-rose-100 hover:bg-rose-500 hover:text-white" },
    { name: "Society AMC", icon: TreePine, slug: "amc-society", pillar: "amc", color: "bg-teal-50 text-teal-600 border-teal-100 hover:bg-teal-500 hover:text-white" },
  ];
  ...
  const trendingDeals = [
    ...
    },
    {
      ...
      badge: "Best Seller", badgeColor: "bg-emerald-500 text-white",
    ...
    },
    {
      ...
      badge: "36% OFF", badgeColor: "bg-purple-500 text-white",
    ...
    },
    {
      ...
      badge: "Express", badgeColor: "bg-amber-500 text-white",
    ...
    },
    {
      ...
      badge: "Safe & Eco", badgeColor: "bg-red-500 text-white",
    ...
    },
    {
      ...
      icon: Sparkles, slug: "cleaning-services",
      badge: "Premium Clean", badgeColor: "bg-emerald-500 text-white",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between border-b border-gray-100 pb-5">
          ...
          <div className="mt-4 md:mt-0 flex gap-4 text-xs font-bold text-gray-500">
            ...
            <div className="flex items-center gap-1"><TrendingUp className="w-4 h-4 text-emerald-500" /> On-Time Guarantee</div>
          </div>
        </div>
        ...
        {activeTab !== 'all' && (
          <div className="mb-4 flex items-center gap-2">
            <span className={`text-xs font-black px-3 py-1 rounded-full ${
              ...
              activeTab === 'design' ? 'bg-emerald-100 text-emerald-700' :
              activeTab === 'specialty' ? 'bg-purple-100 text-purple-700' :
              ...
              >
                ...
                {activeTab === 'all' && (
                  <span className={`mt-1.5 text-[7px] font-black uppercase px-1.5 py-0.5 rounded ${
                    ...
                    cat.pillar === 'design' ? 'bg-emerald-50 text-emerald-600' :
                    cat.pillar === 'specialty' ? 'bg-purple-50 text-purple-600' :
                  ...
                  <div className="p-4 flex flex-col gap-3 flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-0.5">
                        {[1,2,3,4,5].map(i => (
                          <Star key={i} className={`w-3 h-3 ${ i <= Math.floor(service.rating) ? 'text-amber-400 fill-amber-400' : 'text-gray-200 fill-gray-200'}`} />
                        ))}
                      </div>
