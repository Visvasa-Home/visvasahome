      ...
      <div className="w-full h-full bg-slate-950 relative overflow-hidden rounded-3xl flex flex-col items-center justify-center p-6 border border-slate-800">
        ...
        <div className="w-full mt-4 bg-slate-900/90 border border-slate-800/80 rounded-2xl p-4 text-left font-mono space-y-1.5 shadow-inner">
          ...
          <div className="text-[10px] space-y-1">
            <p className={matchingStep >= 0 ? "text-blue-400" : "text-gray-600"}>
              {matchingStep >= 0 ? "✔ " : "○ "} Initializing search grid: Jaipur Hub...
            </p>
            <p className={matchingStep >= 1 ? "text-blue-400" : matchingStep === 0 ? "text-blue-400 animate-pulse" : "text-gray-600"}>
              {matchingStep >= 1 ? "✔ " : matchingStep === 0 ? "⚡ " : "○ "} Safety checks & toolbox validation: CLEAR
            </p>
            <p className={matchingStep >= 2 ? "text-blue-400" : matchingStep === 1 ? "text-blue-400 animate-pulse" : "text-gray-600"}>
              {matchingStep >= 2 ? "✔ " : matchingStep === 1 ? "⚡ " : "○ "} Pinging matching experts in 2.5km radius...
            </p>
            <p className={matchingStep >= 3 ? "text-blue-400" : matchingStep === 2 ? "text-blue-400 animate-pulse" : "text-gray-600"}>
      ...
      return (
        <div className="min-h-screen bg-gradient-to-tr from-gray-900 via-slate-800 to-gray-900 flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl text-center border border-gray-100">
            ...
            <div className="w-20 h-20 bg-gradient-to-br from-blue-400 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg shadow-blue-500/30">
              <span className="text-3xl font-black text-white">+{pointsEarned}</span>
            </div>
            <div className="inline-flex items-center gap-1.5 bg-blue-50 border border-blue-200 text-blue-700 text-xs font-extrabold px-3 py-1 rounded-full mb-3">
              <Star className="w-3 h-3 fill-amber-500 text-blue-500" /> Loyalty Points Earned!
            </div>
            <h3 className="text-xl font-extrabold text-gray-800 mb-1">Thank You! 🎉</h3>
            <p className="text-gray-500 text-sm mb-6 leading-relaxed">
              Your review helps others choose better. You've earned <strong className="text-blue-600">{pointsEarned} loyalty points</strong> for this booking.
            </p>

            {/* Personalised Offer Nudge */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-600 rounded-2xl p-4 text-white text-left mb-5 relative overflow-hidden">
            ...
            <div className="space-y-2.5">
              ...
              <button
                ...
                className="w-full py-2.5 text-sm font-bold text-blue-600 hover:text-blue-700 bg-blue-50 rounded-xl border border-blue-200 transition-colors"
              >
        ...
        <div className="bg-white rounded-3xl p-8 max-w-sm w-full shadow-2xl text-center border border-gray-100 transform scale-100 transition-all">
          ...
          <div className="flex justify-center gap-3 mb-5">
            {[1, 2, 3, 4, 5].map(n => (
              ...
              >
                <Star className={`w-10 h-10 transition-colors ${n <= rating ? 'text-blue-400 fill-yellow-400' : 'text-gray-200'}`} />
              </button>
            ))}
          </div>
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex-1 max-w-4xl w-full mx-auto grid grid-cols-1 md:grid-cols-12 gap-0 md:gap-5 p-0 md:p-4">
        ...
        <div className="md:col-span-7 flex flex-col h-[340px] md:h-[550px] relative">
          ...
          {status === 'arrived' && (
            <div className="absolute top-4 left-4 right-4 bg-blue-500 text-white shadow-lg rounded-2xl p-4 text-center z-10 animate-bounce">
              <p className="text-[10px] font-bold uppercase tracking-widest text-blue-100">Arrived</p>
        ...
        <div className="md:col-span-5 bg-white rounded-t-3xl md:rounded-3xl p-5 border-t md:border border-gray-200 shadow-xl space-y-5 -mt-6 md:mt-0 z-10">
          ...
          {status === 'confirmed' ? (
            ...
            <div className="flex items-center gap-3.5 pb-4 border-b border-gray-100">
              <div className="w-12 h-12 bg-gradient-to-tr from-[#FC8019] to-blue-500 text-white rounded-full flex items-center justify-center font-black text-lg relative shadow-md">
                {(booking?.professionalName || mockProfessional.name)[0]}
                <span className="absolute bottom-0 right-0 bg-blue-500 border border-white w-3 h-3 rounded-full" />
              </div>
              <div className="flex-1 text-left">
                <div className="flex items-center gap-1.5">
                  <h4 className="font-black text-gray-800 text-sm">{booking?.professionalName || mockProfessional.name}</h4>
                  <span className="text-[9px] bg-blue-50 text-blue-700 border border-blue-200 font-extrabold px-1.5 py-0.5 rounded-md uppercase">Service Pro</span>
                </div>
          ...
          <div className="space-y-2">
            {status === 'arrived' && (
              <div className="bg-blue-50 border border-blue-100 rounded-2xl p-4 space-y-3">
                ...
                <div className="flex items-center gap-2">
                  <p className="text-2xl font-mono font-black tracking-widest text-[#FC8019] bg-white border border-blue-200 px-4 py-1.5 rounded-xl w-max">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-50 border border-blue-100 rounded-2xl p-3.5 flex items-center gap-3">
      ...
      {/* SOS Modal */}
      {showSos && (
        <div className="fixed inset-0 bg-blue-950/70 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-fade-in">
          <div className="bg-white rounded-3xl p-6 w-full max-w-sm border-2 border-blue-200 shadow-2xl animate-scale-up">
            <div className="flex items-center gap-3.5 text-blue-600 mb-4 border-b border-blue-50 pb-3">
              <div className="p-2.5 bg-blue-50 rounded-2xl">
                <AlertTriangle className="w-6 h-6 animate-ping" />
              </div>
              <div>
                <h4 className="font-extrabold text-base">Safety Assistance Active</h4>
                <p className="text-[10px] text-blue-500 font-bold uppercase tracking-wider">Secure Escort & Help</p>
              </div>
            </div>
            ...
            <div className="space-y-2.5 mb-5">
              <a
                href="tel:112"
                className="w-full flex items-center justify-between p-3.5 bg-blue-50 border border-blue-100 hover:bg-blue-100 rounded-2xl transition-all"
              >
                <div className="flex items-center gap-2">
                  <Phone className="w-4 h-4 text-blue-600" />
                  <span className="text-xs font-bold text-blue-700">Police Assistance</span>
                </div>
                <span className="text-[10px] font-black bg-blue-600 text-white px-2 py-0.5 rounded-full">Call 112</span>
              </a>
      ...
      {showCallModal && (
        <div className="fixed inset-0 bg-slate-950/95 z-50 flex flex-col items-center justify-between py-16 px-6 text-white backdrop-blur-md animate-fade-in">
          <div className="text-center mt-12 space-y-3">
            <div className="w-24 h-24 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full flex items-center justify-center text-3xl font-black shadow-2xl border-4 border-slate-800 mx-auto relative">
              {mockProfessional.name[0]}
              {callState === 'connected' && (
                <span className="absolute bottom-0 right-0 bg-blue-500 border-2 border-slate-950 p-1.5 rounded-full w-4 h-4 animate-ping" />
              )}
            </div>
            <div>
            ...
            {callState === 'connected' && (
              <span className="inline-block bg-blue-600/25 text-blue-400 border border-blue-500/20 px-3 py-0.5 rounded-full text-xs font-mono">
          ...
          <button
            ...
            className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center shadow-2xl hover:bg-blue-700 active:scale-90 transition-all"
          >
            ...
            <div className="bg-white border-b border-gray-100 px-5 py-4 flex items-center justify-between shadow-xs">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-blue-500 font-bold uppercase">Online · Service Partner</p>
                </div>
              </div>
              <button
