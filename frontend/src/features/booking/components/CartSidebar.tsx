  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-150 shadow-sm overflow-hidden flex flex-col">
      ...
      <div className="p-4 bg-gray-50/80 border-t border-gray-100 space-y-3">
        ...
        <button
          onClick={onCheckout}
          className="w-full mt-2 flex items-center justify-center gap-2 bg-[#6b2ac8] hover:bg-[#5b24aa] text-white py-3 rounded-xl font-bold text-sm transition-colors shadow-md shadow-blue-500/20 active:scale-[0.98]"
        >
