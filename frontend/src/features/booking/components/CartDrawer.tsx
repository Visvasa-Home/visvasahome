              ...
              {cart.items.map((item) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    {/* Color dot */}
                    <div className="w-2.5 h-2.5 rounded-sm bg-blue-500 mt-1.5 flex-shrink-0" />
              ...
              <div className="bg-white border border-dashed border-gray-200 rounded-2xl p-4">
                ...
                {appliedPromo ? (
                  <div className="flex items-center justify-between bg-blue-50 border border-blue-200 rounded-xl px-3 py-2.5">
                    <div>
                      <p className="text-xs font-black text-blue-700">{promoCode.toUpperCase()} applied! 🎉</p>
                      <p className="text-[10px] text-blue-600 font-semibold mt-0.5">{appliedPromo.label}</p>
                    </div>
                    <button
                ...
                {promoError && <p className="text-[10px] text-blue-500 font-semibold mt-1.5">{promoError}</p>}
              </div>
