        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              { icon: Star, label: 'Rate a Service', color: 'bg-blue-100 text-blue-600', action: 'bookings' },
              { icon: Shield, label: 'Report an Issue', color: 'bg-blue-100 text-blue-600', action: 'chat' },
