            ...
            <div>
              ...
              {sent ? (
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-blue-800" style={{ fontWeight: 600 }}>Gift Card Sent!</p>
                    <p className="text-blue-700 text-sm">Your gift card of ₹{finalAmount.toLocaleString()} has been sent to {recipientName || 'the recipient'}.</p>
                  </div>
                </div>
              ) : (
                <button
