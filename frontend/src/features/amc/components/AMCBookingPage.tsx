...
const TIER_COLORS: Record<string, string> = {
  platinum: 'from-blue-600 to-blue-800',
  gold: 'from-blue-500 to-blue-600',
...
const TIER_BG: Record<string, string> = {
  ...
  gold: 'bg-blue-50 border-blue-200',
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl border px-4 py-3 text-sm font-semibold text-slate-900 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${errors.name ? 'border-blue-400 bg-blue-50' : 'border-slate-200'}`}
                  />
                  {errors.name && <p className="text-blue-500 text-xs font-bold mt-1">{errors.name}</p>}
                </div>
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl border px-4 py-3 text-sm font-semibold text-slate-900 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${errors.phone ? 'border-blue-400 bg-blue-50' : 'border-slate-200'}`}
                  />
                  {errors.phone && <p className="text-blue-500 text-xs font-bold mt-1">{errors.phone}</p>}
                </div>
              </div>
              <div>
                ...
                <input
                  ...
                  className={`w-full rounded-xl border px-4 py-3 text-sm font-semibold text-slate-900 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${errors.email ? 'border-blue-400 bg-blue-50' : 'border-slate-200'}`}
                />
                {errors.email && <p className="text-blue-500 text-xs font-bold mt-1">{errors.email}</p>}
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-100 p-5 space-y-4 shadow-sm">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className={`w-full rounded-xl border px-4 py-3 text-sm font-semibold text-slate-900 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all resize-none ${errors.address ? 'border-blue-400 bg-blue-50' : 'border-slate-200'}`}
                />
                {errors.address && <p className="text-blue-500 text-xs font-bold mt-1">{errors.address}</p>}
              </div>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <div className="col-span-2 sm:col-span-1">
                  ...
                  <input
                    ...
                    placeholder="Jaipur"
                    className={`w-full rounded-xl border px-4 py-3 text-sm font-semibold text-slate-900 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${errors.city ? 'border-blue-400 bg-blue-50' : 'border-slate-200'}`}
                  />
                  {errors.city && <p className="text-blue-500 text-xs font-bold mt-1">{errors.city}</p>}
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="302001"
                    className={`w-full rounded-xl border px-4 py-3 text-sm font-semibold text-slate-900 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${errors.pincode ? 'border-blue-400 bg-blue-50' : 'border-slate-200'}`}
                  />
                  {errors.pincode && <p className="text-blue-500 text-xs font-bold mt-1">{errors.pincode}</p>}
                </div>
              </div>
            </div>
          ...
          <div className="space-y-5">
            <div className="bg-white rounded-3xl border border-slate-100 p-5 space-y-4 shadow-sm">
              ...
              <input
                ...
                className={`w-full rounded-xl border px-4 py-3 text-sm font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${errors.preferredDate ? 'border-blue-400 bg-blue-50' : 'border-slate-200'}`}
              />
              {errors.preferredDate && <p className="text-blue-500 text-xs font-bold mt-1">{errors.preferredDate}</p>}
            </div>
              ...
              {form.paymentMethod === 'upi' && (
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl border px-4 py-3 text-sm font-semibold text-slate-900 placeholder-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all ${errors.upiId ? 'border-blue-400 bg-blue-50' : 'border-slate-200'}`}
                  />
                  {errors.upiId && <p className="text-blue-500 text-xs font-bold mt-1">{errors.upiId}</p>}
                </div>
              )}
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full text-center space-y-6">
        {/* Success icon */}
        <div className="w-24 h-24 bg-gradient-to-br from-blue-400 to-blue-600 rounded-full flex items-center justify-center mx-auto shadow-2xl shadow-blue-500/30">
        ...
        <div>
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <span className="text-[11px] font-extrabold text-blue-600 uppercase tracking-widest">AMC Activated Successfully</span>
            <Sparkles className="w-4 h-4 text-blue-500" />
          </div>
