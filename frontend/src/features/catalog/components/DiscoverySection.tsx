...
function AppPhoneMockup() {
  ...
  const steps = [
    ...
    { label: "Book in 60s", icon: "📅", color: "from-blue-500 to-blue-600" },
    { label: "Track Live", icon: "📍", color: "from-blue-500 to-blue-600" },
    { label: "Rate & Review", icon: "⭐", color: "from-blue-500 to-blue-500" },
  ];
  ...
  return (
    <div className="relative mx-auto w-[160px] select-none">
      ...
      <div className="absolute -left-8 bottom-16 bg-white rounded-xl shadow-xl border border-gray-100 px-2 py-1.5 flex items-center gap-1 w-[72px]">
        <Star className="w-3 h-3 text-blue-500 fill-amber-500 shrink-0" />
...
function ReferralNetwork() {
  ...
  const nodes = [
    { name: "Priya", color: "bg-blue-500", top: "10%", left: "50%", bonus: "₹200 earned" },
    { name: "Rahul", color: "bg-blue-500", top: "45%", left: "15%", bonus: "₹150 earned" },
    { name: "Sunita", color: "bg-blue-500", top: "45%", left: "85%", bonus: "₹200 earned" },
    { name: "Amit", color: "bg-blue-500", top: "80%", left: "30%", bonus: "₹150 earned" },
    { name: "Meera", color: "bg-blue-500", top: "80%", left: "70%", bonus: "₹200 earned" },
  ];
        ...
        >
          ...
          {i === active && (
            <div className="bg-white border border-gray-100 rounded-lg px-1.5 py-0.5 shadow-md">
              <span className="text-[7px] font-black text-blue-600">{node.bonus}</span>
            </div>
          )}
        </div>
      ))}
...
function AdsReachVisual() {
  const platforms = [
    { name: "Google", icon: "🔍", reach: "2.4M", color: "from-blue-500 to-blue-500", pct: 85 },
    { name: "Instagram", icon: "📸", reach: "1.8M", color: "from-blue-500 to-blue-500", pct: 72 },
    { name: "YouTube", icon: "▶️", reach: "1.2M", color: "from-blue-600 to-blue-500", pct: 60 },
  ...
  return (
    <div ref={ref} className="space-y-3 w-full max-w-[260px] mx-auto">
      ...
      <div className="pt-1 flex items-center gap-2 bg-gradient-to-r from-blue-50 to-blue-50 rounded-xl p-2">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`grid grid-cols-3 gap-4 max-w-2xl mx-auto mb-14 transition-all duration-700 delay-150 ${inView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
          {[
            ...
            { value: `${citiesCount}+`, label: "Cities Covered", color: "text-blue-600" },
            { value: `${prosCount.toLocaleString()}+`, label: "Verified Pros", color: "text-blue-600" },
          ].map((stat, i) => (
        ...
        >
          ...
          <div className="absolute -right-8 -bottom-12 w-32 h-32 rounded-full bg-blue-700/20 pointer-events-none" />
