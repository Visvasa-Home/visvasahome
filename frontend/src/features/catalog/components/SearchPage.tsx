      ...
      <div className="max-w-4xl mx-auto px-4 py-5">
        {showSuggestionsPortal ? (
          <div className="space-y-8 animate-fade-in py-2">
            ...
            {/* Safe & Secure Banner */}
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-3xl p-5 text-white shadow-premium flex flex-col sm:flex-row items-center gap-4">
          ...
          <>
            ...
            {resultsToShow.length === 0 ? (
              ...
              <div className="space-y-4">
                {filtered.length > 50 && (
                  <p className="text-xs text-blue-600 bg-blue-50 px-3 py-2.5 rounded-xl font-semibold border border-blue-100 mb-3">
