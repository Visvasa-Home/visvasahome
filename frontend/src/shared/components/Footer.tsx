...
const SERVICES = [
  ...
  { label: 'Electrician', page: 'electrical-services' },
  { label: 'Home Cleaning', page: 'cleaning-services' },
  { label: 'Appliance Repair', page: 'appliance-repair' },
  { label: 'RO Service', page: 'ro-services' },
  { label: 'Doctor at Home', page: 'doctor-home-visit' },
  { label: 'Pest Control', page: 'pest-control' },
  { label: 'Carpentry', page: 'carpentry-services' },
  { label: 'Painting', page: 'painting-services' },
  { label: 'Car Wash', page: 'vehicle-washing' },
  { label: 'Packers & Movers', page: 'packers-movers' },
  { label: 'Women\'s Salon', page: 'beauty-services' },
  { label: 'Men\'s Salon', page: 'wellness-services' },
  { label: 'Physiotherapy', page: 'physiotherapy' },
  { label: 'Elderly Care', page: 'elderly-care' },
