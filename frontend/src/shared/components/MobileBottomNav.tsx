...
export function MobileBottomNav({ currentPage, onNavigate, onMenuOpen }: MobileBottomNavProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-gray-100 pb-[env(safe-area-inset-bottom)] z-[999] shadow-[0_-8px_30px_-15px_rgba(0,0,0,0.12)] rounded-t-3xl w-full md:max-w-3xl lg:max-w-5xl xl:max-w-7xl mx-auto">
