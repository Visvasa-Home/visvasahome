  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#2563EB] to-blue-600 p-6 rounded-t-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {submitStatus === 'success' && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-blue-900 mb-1">Feedback Received!</h4>
                <p className="text-sm text-blue-700">Thank you for helping us improve VisvasaHome.</p>
              </div>
            </div>
          )}
