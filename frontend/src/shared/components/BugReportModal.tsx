  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-600 to-blue-600 p-6 rounded-t-2xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">Help us improve VisvasaHome</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {submitStatus === 'success' && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-blue-900 mb-1">Bug Report Submitted!</h4>
                <p className="text-sm text-blue-700">Thank you for helping us improve. We'll investigate this issue.</p>
              </div>
            </div>
          )}
          ...
          {submitStatus === 'error' && (
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start gap-3">
              <AlertCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
              <div>
                <h4 className="font-semibold text-blue-900 mb-1">Submission Failed</h4>
                <p className="text-sm text-blue-700">Please try again or email us at support@visvasahome.com</p>
              </div>
            </div>
          )}
