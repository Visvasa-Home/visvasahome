    ...
    <>
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3">
        ...
        {isMenuOpen && (
          <div className="flex flex-col gap-2 animate-in slide-in-from-bottom-2 fade-in duration-200">
            ...
            <button
              ...
              className="group flex items-center gap-3 bg-white rounded-full px-5 py-3 shadow-lg hover:shadow-xl transition-all border border-gray-200 hover:border-blue-300"
            >
              <div className="bg-blue-100 p-2 rounded-full group-hover:bg-blue-600 transition-colors">
                <Bug className="w-5 h-5 text-blue-600 group-hover:text-white" />
              </div>
              <span className="font-semibold text-gray-900 whitespace-nowrap pr-2">
                Report a Bug
              </span>
        ...
        <button
          ...
          className={`group relative bg-gradient-to-r from-[#2563EB] to-blue-600 text-white rounded-full p-4 shadow-lg hover:shadow-2xl transition-all hover:scale-110 ${
