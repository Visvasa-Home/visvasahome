...
import { ReferAndEarnPage } from '@customer/components/ReferAndEarnPage';
import { ServiceListPage } from './features/catalog/components/ServiceListPage';
import { HomeFeed } from './features/catalog/components/HomeFeed';
...
import { EducationServicesPage } from '@catalog/components/EducationServicesPage';
...
function MainApp() {
  ...
  if (currentPage === 'education-services') {
    return (
      <>
        <SEO title={meta.title} description={meta.description} />
        <EducationServicesPage onBack={() => navigate('home')} onBookNow={() => bookService('Education')} />
      </>
    );
  }
